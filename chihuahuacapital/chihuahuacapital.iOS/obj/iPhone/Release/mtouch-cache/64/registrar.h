...
@class chihuahuacapital_iOS_Renderers_IosExtendedWebView_MyWebViewDelegate;
@class Xamarin_Forms_Platform_iOS_VisualElementRenderer_1;
@class Xamarin_Forms_Platform_iOS_ViewRenderer_2;
@class chihuahuacapital_iOS_Renderers_IosExtendedWebView;
...
@interface chihuahuacapital_iOS_Renderers_IosExtendedWebView_MyWebViewDelegate : NSObject<WKNavigationDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface chihuahuacapital_iOS_Renderers_IosExtendedWebView : Xamarin_Forms_Platform_iOS_ViewRenderer_2<WKScriptMessageHandler> {
}
